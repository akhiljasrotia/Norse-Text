...
export default class Freya extends React.Component{
            ...
            <ScrollView>
              ...
              <View style={styles.container1}>
                ...
                <View style={styles.textBox1}>
                  ...
                  The name Freya (in Old Norse “Freyja)” means “lady”, and can also be spelled (Freya, Freija, Frejya, Freyia, Fröja, Frøya, Frøjya, Freia, Freja, Frua, and Freiya).
                  She does not originate from the Aesir but she is from the Vanir, she and two other Gods were sent to the Aesir by the Vanir as a token of truce, in return, the Aesir also sent two Gods to the Vanir.
                  Freya became an honorable member of the Aesir after the war between the Aesir and Vanir ended.
                   {"\n"}{"\n"}
                  Freya is the daughter of Njord and his sister Nerthus, and she has a twin brother named Freyr.
                  Freya is married to the God Odr, but he somehow disappeared but it might be Odin, she has two children with Odr, their names are Hnoss and Gersimi.
                  </Text>
                  <Text style={styles.text1}>
                    Animals and feathers
                  </Text>
                  <Text style={styles.text2}>
                  Freya loves to travel and she would sometimes take a ride in her chariot pulled by two black or gray cats.
                  But she was also able to fly, by using her cloak of falcon feathers, which she willingly loaned out to the other Gods and Goddesses in Asgard, when they needed to fly to one of the worlds in a hurry.
                  Freya also has a boar named Hildisvini “battle swine” which she rides when she is not using her cat-drawn chariot.
                  It is also said to be Freya’s human lover, Ottar in disguise, and that is the reason why Loki consistently accuses her of being immoral by riding her lover in public.
                  </Text>
              </View>
              </View>
